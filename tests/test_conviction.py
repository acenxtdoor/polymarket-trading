...
def run_tests():
    ...
    res1 = agg.process(s1, engine, 500.0, bankroll)
    ...
    res2 = agg.process(s2, engine, 500.0, bankroll)
    ...
    res3 = agg.process(s3, engine, 500.0, bankroll)
    ...
    res4 = agg.process([], engine, 500.0, bankroll)
    ...
    agg2.process([old_signal], engine, 500.0, bankroll)
